...
const TermsOfService = () => {
  ...
  <div class="max-w-5xl mx-auto">
    <div class="bg-white shadow-md rounded-lg p-6 md:p-10">
      ...
      <p class="mb-4">
        Welcome to <span class="font-semibold">crepculture</span>,
      ...
      <h3 class="text-2xl font-semibold mt-8 mb-3">1. Acceptance of Terms</h3>
      <p class="mb-4">
      ...
      <h3 class="text-2xl font-semibold mt-8 mb-3">2. Eligibility</h3>
      <p class="mb-4">
      ...
      <h3 class="text-2xl font-semibold mt-8 mb-3">3. Product Availability and Accuracy</h3>
      ...
      <h3 class="text-2xl font-semibold mt-8 mb-3">4. Pricing and Payments</h3>
      <ul class="list-disc pl-6 mb-4 space-y-1">
      ...
      <h3 class="text-2xl font-semibold mt-8 mb-3">5. Shipping and Delivery</h3>
      <p class="mb-4">
        For information regarding shipping, delivery times, and shipping charges, please refer to our <strong>Shipping Policy</strong>.
      </p>

      <h3 class="text-2xl font-semibold mt-8 mb-3">6. Returns and Refunds</h3>
      <p class="mb-4">
      ...
      <h3 class="text-2xl font-semibold mt-8 mb-3">7. Intellectual Property</h3>
      <p class="mb-4">
        All content, including logos, product images, designs, and text, are the property of <strong>crepculture</strong> or its licensors. 
        You may not use, reproduce, distribute, or modify any content without prior written consent from us.
      </p>

      <h3 class="text-2xl font-semibold mt-8 mb-3">8. User Conduct</h3>
      <p class="mb-2">You agree to use our website only for lawful purposes and in accordance with these terms. You are prohibited from:</p>
      <ul class="list-disc pl-6 mb-4 space-y-1">
      ...
      <h3 class="text-2xl font-semibold mt-8 mb-3">9. Limitation of Liability</h3>
      <p class="mb-4">
        To the fullest extent permitted by law, <strong>crepculture</strong> and its affiliates will not be liable for any direct, indirect, incidental, 
        or consequential damages arising from your use of our website, products, or inability to access our services.
      </p>

      <h3 class="text-2xl font-semibold mt-8 mb-3">10. Indemnification</h3>
      <p class="mb-4">
        You agree to indemnify and hold harmless <strong>crepculture</strong>, its employees, directors, and affiliates from any claims, damages, 
        or expenses arising from your violation of these <strong>Terms of Service</strong> or misuse of our website.
      </p>

      <h3 class="text-2xl font-semibold mt-8 mb-3">11. Modifications to Terms</h3>
      <p class="mb-4">
      ...
      <h3 class="text-2xl font-semibold mt-8 mb-3">12. Governing Law</h3>
      <p class="mb-4">
      ...
      <h3 class="text-2xl font-semibold mt-8 mb-3">13. Contact Us</h3>
      <p class="mb-2">If you have any questions or concerns regarding these terms, please contact us:</p>
